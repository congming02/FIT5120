		...
		?>
			...
			<div class="<?php echo esc_attr( $main_css_class ); ?>">
				...
				<h1 class="wc-page-title">
					<?php echo esc_html__( 'Search result for: ', 'productive-business' ) . esc_html( get_search_query() ); ?>
				</h1>
				...
				<?php if ( trim( get_search_query() ) != '' && $wp_query->found_posts > 0 ) { ?>
					<div class="search-result-number">
						...
						if ( $found_posts > 1 ) {
							echo esc_attr( $found_posts ) . esc_html__( ' matches found for your search...', 'productive-business' );
						} else {
							echo esc_attr( $found_posts ) . esc_html__( ' match found for your search...', 'productive-business' );
						}
						?>
					</div>
					...
					<div class="search_prev_next_nav">
