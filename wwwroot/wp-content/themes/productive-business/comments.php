...
if ( $comments ) {
	...
	<div class="post-comments" id="comments">
		...
		<div class="comments-header">
			...
			<?php
			if ( ! have_comments() ) {
				echo esc_html_e( 'Leave a comment', 'productive-business' );
			} else {
				echo esc_html_e( 'Comments on ', 'productive-business' ) . esc_html( get_the_title() ) . ' (' . esc_html( number_format_i18n( $comments_number ) ) . ')';
			}
			?>
			</h2>
		</div>
...
<div class="post-comments-reply" id="post-comments-reply">
	...
	<?php } else { ?>
		...
		<div class=""><?php esc_html__( 'Comments are closed', 'productive-business' ); ?> </div>
