...
$i++;
$cfg['Servers'][$i]['host'] 			= 'wwyes-bc584cba54844c14bada7a3b6fbdafb6-dbserver.mysql.database.azure.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'bzgB?4BypkQH6>\'YHlg>h9-(#.U&*\"&@' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_OZ52SlFCHf3VrRBT6Enih8m/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
